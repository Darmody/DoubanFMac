...
import {
  FETCH_SUCCESS, LIKE_SUCCESS, DISLIKE_SUCCESS, BAN_SUCCESS, BAN_FAILURE, REFUSE,
  PLAY, PAUSE, NEXT, JUMP,
} from '../../actionTypes/daily';
import favorite, {
  fetch, like, dislike, ban, play, pause, next, jump,
} from '../daily';
...
describe('Daily Actions', function actions() {
  afterEach(() => {
    nock.cleanAll();
  });
...
describe('Daily Reducers', function reducers() {
